...
class MainRecommender:
    ...
    def __init__(self, data: pd.DataFrame, weighting: bool = True):
        ...
        if weighting:
            self.user_item_matrix = bm25_weight(self.user_item_matrix.T, K1=10, B=0.05).T
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=200, regularization=0.1, iterations=5, num_threads=8):
        """Обучает ALS"""
